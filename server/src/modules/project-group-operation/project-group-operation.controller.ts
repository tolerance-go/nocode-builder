...
export class ProjectGroupOperationController {
  constructor(private readonly projectGroupOperationService: ProjectGroupOperationService) {}
  ...
  async getProjectGroupOperation(
    ...
    const projectGroupOperation = await this.projectGroupOperationService.projectGroupOperation({
      id: Number(id),
    });
    return projectGroupOperation ? toProjectGroupOperationDto(projectGroupOperation) : null;
  }
  ...
  async getProjectGroupOperations(
    ...
    const projectGroupOperations = await this.projectGroupOperationService.projectGroupOperations({
      skip: query.skip,
      take: query.take,
  ...
  async createProjectGroupOperation(
    ...
    const projectGroupOperation = await this.projectGroupOperationService.createProjectGroupOperation({
      ...rest,
      owner: {
        connect: {
          id: userId,
  ...
  async updateProjectGroupOperation(
    ...
    const projectGroupOperation = await this.projectGroupOperationService.updateProjectGroupOperation({
      where: { id: Number(id) },
      data,
    });
    return toProjectGroupOperationDto(projectGroupOperation);
  ...
  async deleteProjectGroupOperation(@Param('id') id: string): Promise<ProjectGroupOperationDto> {
    const projectGroupOperation = await this.projectGroupOperationService.deleteProjectGroupOperation({
      id: Number(id),
    });
    return toProjectGroupOperationDto(projectGroupOperation);
  }

...
export class ProjectOperationController {
  constructor(private readonly projectOperationService: ProjectOperationService) {}
  ...
  async getProjectOperation(
    ...
    const projectOperation = await this.projectOperationService.projectOperation({
      id: Number(id),
    });
  ...
  async getProjectOperations(
    ...
    const projectOperations = await this.projectOperationService.projectOperations({
      skip: query.skip,
      take: query.take,
  ...
  async createProjectOperation(
    ...
    const projectOperation = await this.projectOperationService.createProjectOperation({
      ...rest,
      owner: {
        connect: {
          id: userId,
  ...
  async updateProjectOperation(
    ...
    const projectOperation = await this.projectOperationService.updateProjectOperation({
      where: { id: Number(id) },
      data,
    });
    return toProjectOperationDto(projectOperation);
  ...
  async deleteProjectOperation(@Param('id') id: string): Promise<ProjectOperationDto> {
    const projectOperation = await this.projectOperationService.deleteProjectOperation({
      id: Number(id),
    });
    return toProjectOperationDto(projectOperation);
  }

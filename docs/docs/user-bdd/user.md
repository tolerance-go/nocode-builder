...
## 👨‍💻 用户可以拖动组件的时候，预览图片应该显示组件实际渲染的样子。 {#preview-component-render}
...
## ✔️ 用户应该看不到没有注册组件实现的组件。 {#hide-unregistered-component}
...
## ✔️ 用户拖动组件的时候，舞台部件的插槽应该显示，其余时间应该隐藏。{#slot-display-dragging}
